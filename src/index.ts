...
console.log(`Starting ${_package.name} ${_package.version}...`);

import "./core/database";

if (process.env.UCHATIFY_DISCORD_TOKEN)
{
	console.log("Discord token founded!");
	const Discord = require('discord.js');

	let bot = new Discord.Client();

	bot.login(process.env.UCHATIFY_DISCORD_TOKEN);
